...
function TabViewModel() {
    ...
    self.tabs.push({
        ...
        tabCaption: "<img src='../images/rise-logo-white.png' style='height: 20vh;; -webkit-filter: drop-shadow(5px 5px 5px #222); filter: drop-shadow(5px 5px 5px #222);'/> ",
        tabImg: "../images/school4.jpg",
        pathToImage: "/images/mockupSC.jpg",
        pathToPDF: "/docs/school chaplains brochure.pdf",
    ...
    self.tabs.push({
        ...
        tabCaption: "",
        tabImg: "../images/galsgroup.jpg",
        pathToImage: "/images/galsgroup.jpg",
        pathToPDF: "/docs/project stealth brochure.pdf", 
    ...
    self.tabs.push({
        ...
        tabCaption: "",
        tabImg: "../images/people2.jpg",
        pathToImage: "/images/mockupPC.jpg",
        pathToPDF: "/docs/patrol chaplains brochure.pdf",
    ...
    self.tabs.push({
        ...
        tabCaption: "",
        tabImg: "../images/supportblue.jpg",
        pathToImage: "/images/supportblue.jpg",
        pathToPDF: "/docs/school chaplains brochure.pdf",
...
var album = function (item) {
    ...
    self.getImages = function (folder, len) {
        ...
        for (var i = 1; i <= len + 1; i++) {
            tmpArray.push({imgPath: ko.observable("../images/" + folder + "/" + i + ".jpg"), id: i});
        }
...
function GalleryViewModel() {
    ...
    self.mainImg = ko.observable("../images/" + self.selectedAlbum().albumFolder + "/1.jpg");
    ...
    $(".galleryNav > span").on("click", function () {
        ...
        var urlStart = "../images/" + self.selectedAlbum().albumFolder + "/";
